...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
      <Link to="/">
        <h2 className="text-5xl font-bold text-primary">GroKan</h2>
      </Link>

      {/* Desktop Menu */}
      <div className="hidden sm:flex items-center gap-8">
        <Link to={"/"}>
          <span className="inline-block text-base font-medium transition-transform duration-300 hover:scale-110">
            Home
          </span>
        </Link>
        <Link to={"/products"}>
        ...
        <form
          ...
          className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full 
            transition-all duration-200 focus-within:border-gray-500 focus-within:shadow-md"
        >
          <input
            value={searchQuery}
